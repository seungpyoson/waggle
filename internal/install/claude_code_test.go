...
func TestInstall_HookUsesNativeEnrollment(t *testing.T) {
	tmpHome := t.TempDir()
	...
	if !strings.Contains(content, "waggle enroll claude-code") {
		t.Fatalf("hook should contain %q", "waggle enroll claude-code")
	}
}
